...
export default function Login() {
  ...
  const [error, setError] = useState<string | null>(
    new URLSearchParams(loc.search).get('error') === 'google'
      ...
      <main className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-md animate-fadeUp">
          <div className="text-center mb-8">
            <h1 className="font-serif text-4xl md:text-5xl tracking-tight2 mb-3">Welcome back.</h1>
            <p className="text-ink-secondary">Sign in to continue your research.</p>
          </div>
          ...
          <p className="text-center text-xs text-ink-tertiary mt-6">
            By signing in you agree to our terms. EquityIQ provides research, not investment advice.
          </p>
        </div>
      </main>
    </div>
