...
export const journal = {
  ...
  parseScreenshot: (images: string[]) =>
    api.post<import('../types').ParsedTrade>('/journal/parse-screenshot', { images }).then((r) => r.data),
  parseText: (text: string) =>
    api.post<import('../types').ParsedTrade>('/journal/parse-text', { text }).then((r) => r.data),
